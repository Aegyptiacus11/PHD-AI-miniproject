...
class Config:
    ...
    vit_model_path: str = "models/vit_best.pth"
    ...
    compare_models: tuple[str, ...] = ("resnet18", "mobilenet", "vit", "swintiny")
    transfer_model_types: frozenset[str] = field(
        default_factory=lambda: frozenset({"mobilenet", "resnet18", "vit", "swintiny"})
    )
